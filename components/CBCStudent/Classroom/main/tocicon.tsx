  ...
  return (
    <>
      ...
      <button
        ...
        className="absolute bottom-3 left-3 sm:bottom-6 sm:left-6 bg-[#0ea5e9] text-white px-3 py-2 sm:px-4 sm:py-3 text-xs sm:text-sm rounded-full shadow-xl hover:bg-[#0284c7] transition-all z-50"
      >
        TOC
      </button>
      ...
      {tocOpen && (
        ...
        >
          <div
            className="absolute bottom-0 left-0 w-full sm:w-1/2 max-h-[80%] bg-[#0c4a6e] rounded-t-2xl shadow-2xl border-t border-x sm:border-r sm:border-l-0 border-sky-400/30 overflow-hidden transform transition-transform duration-300 ease-out"
            style={{
          ...
          >
            {/* Header */}
            <div className="flex items-center justify-between p-4 sm:p-6 border-b border-sky-400/20 bg-[#082f49]">
