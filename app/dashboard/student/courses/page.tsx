        ...
        <div className="min-h-screen">
            ...
            <div className="max-w-4xl mx-auto text-center pt-6 sm:pt-12 pb-4 sm:pb-8 px-4">
                ...
                <div className="mb-4 sm:mb-6">
                    <div className="inline-flex items-center justify-center w-14 h-14 sm:w-20 sm:h-20 rounded-full bg-gradient-to-br from-sky-500/20 to-cyan-600/20 border border-sky-500/30">
                        <svg className="w-7 h-7 sm:w-10 sm:h-10 text-sky-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
