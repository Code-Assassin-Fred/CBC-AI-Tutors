                ...
                <div className="p-5">
                    {activeTab === 'profile' && (
                        <div className="space-y-4">
                            ...
                            {/* Grade */}
                            <div>
                                <label className="block text-xs text-white/50 mb-1.5">Grade Level</label>
                                <select className="w-full px-3 py-2.5 bg-white/5 border border-white/10 rounded-lg text-white text-sm focus:outline-none focus:border-[#0ea5e9]/50">
                                    <option value="" className="bg-[#0b0f12]">Select grade</option>
                                    {[4, 5, 6, 7, 8, 9, 10, 11, 12].map((grade) => (
                                        <option key={grade} value={grade} className="bg-[#0b0f12]">
                                            Grade {grade}
                                        </option>
                                    ))}
                                </select>
                    ...
                    {activeTab === 'account' && (
                        <div className="space-y-4">
                            ...
                            <div className="py-3 border-b border-white/10">
                                ...
                                <p className="text-xs text-white/50 mt-0.5">Free Trial - 7 days left</p>
                            </div>
